...
func generateGenesisCheckpoint() (*core.Checkpoint, error) {
	...
	validators := []string{
		...
		// "047218B694EADE89FFC37CEFB6FF5C6EE3F36A0AB5F11F3EE30B79D38D9B7DEBCA4CC963FAB90EC20F0D849781EB0A1E4C2A89FF1E8CF479C533254B4283DBE989",
		// "0434F9F1D3F0C35EB40304A8207D65465F828D59C4788613B881717163804707A561D665FC5469D05EEE47A241587662186681C36C58FCC96E3784C21132163467",
		// "04267930FCFE9058D214FB54209D6BF55736F2D4845D7A95798918E295071B072B933A4C633DA62954C99F4DB506F5DDB504E034428B6FBCA3FB1F012E48D1B59B",
	}
	...
	for _, v := range validators {
		...
		tfuel, _ := types.ParseCoinAmount("1250000000")
		acc := &types.Account{
