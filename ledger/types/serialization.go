...
// 	obj.ReserveSequence = uint32(msg.ReserveSequence)
...
// 	r.ReserveSequence = uint32(rf.ReserveSequence)
...
// 	txInput.Sequence = uint32(ti.Sequence)
...
// 	// rf.Fee = *CoinFromProto(tx.Fee)
// 	rf.Source = *InputFromProto(tx.Source)
// 	rf.ReserveSequence = uint32(tx.ReserveSequence)
// 	return rf
// }
